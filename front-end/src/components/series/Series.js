  ...
  render() {
    const images = [
      {
        slug: 'iphone-x',
        url:
          'https://images.apple.com/v/iphone-x/e/images/specs/finish_iphone-x_dark_gray_small.jpg',
      },
      {
        slug: 'iphone-8',
        url:
    ...
    return (
      <div className="Series">
        <ModelsGroup
          models={this.getModelsFromSlugs(['iphone-x'])}
          image={images.find(image => image.slug === 'iphone-x').url}
        />
        <ModelsGroup
